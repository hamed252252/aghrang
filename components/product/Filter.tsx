...
const Filter: React.FC = () => {
    return (
        <div className="flex justify-center items-center w-full h-full">
            <div className="mx-2 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
                {/* Sheet component for Filter */}
                <Sheet>
                    {/* SheetTrigger should not have a button inside; use it directly */}
                    <SheetTrigger asChild>
                        <div className=" flex flex-row justify-between items-center font-iransans p-2 bg-blue-500 text-white rounded cursor-pointer">
                            فیلتر
                            <ChevronDown />
                        </div>
                    </SheetTrigger>
            ...
            <Input
                type="search"
                placeholder="جستجو..."
                className="font-iransans p-2 flex justify-center items-center"
            />
        </div>
    );
};
